...
import { generateCookingTips } from "../utils/gemini.js";
...
export const generateRecipe = async (req, res, next) => {
  try {
    ...
    // ✅ Add this line
    recipe.cookingTips = await generateCookingTips(recipe);
...
export const getRecentRecipes = async (req, res) => {
  try {
    ...
    console.error("getRecentRecipes error:", error); // log real error
